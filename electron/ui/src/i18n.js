...
const T = {
  ...
  de_db_limite: { es: "Tope de filas (0 = sin tope)", en: "Row cap (0 = no cap)", pt: "Limite de linhas (0 = sem limite)" },
  de_db_recorte: { es: "«{tabla}»: se analizaron {n} de {total} filas por el tope elegido. Poné 0 para analizar todo.",
