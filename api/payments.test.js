...
async function main() {
  ...
  // El trial autoservicio (api/trial.js) se eliminó junto con la descarga
  // abierta: emitía una licencia Professional de 14 días a cualquiera que
  // dejara un email, y esa licencia alcanzaba para bajar el programa — la
  // misma puerta que se acababa de cerrar, un paso más adentro. La prueba
  // hoy se entrega después de la demo 1 a 1 (ver api/acceso.js). El plan
  // "trial" sigue existiendo: lo emite una persona vía "Emitir licencia".
