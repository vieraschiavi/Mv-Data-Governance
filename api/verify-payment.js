...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Se registra si la compra otorga ALGO. Hoy eso es solo la licencia; si
    // manana se agrega otra cosa que se entregue al pagar, tiene que sumarse
    // a esta condicion o quedara fuera del registro — que fue exactamente lo
    // que paso con los packs de creditos mientras existieron.
    const otorga = Boolean(plan && privKey);
