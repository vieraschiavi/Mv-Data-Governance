...
_T: dict[str, dict[str, str]] = {
    ...
    # ----------------------------------------------------- Data Steward
    "tab_steward": {"es": 'Data Steward', "en": 'Data Steward', "pt": 'Data Steward'},
    "stw_intro": {"es": 'El lugar del Data Steward: la ficha de cada dataset (dueño, steward, custodio, criticidad, SLA de frescura y de calidad, sensibilidad), su certificación, la cola de incidentes de calidad, el contrato de esquema y la auditoría de cada cambio de criterio. Todo queda versionado: nada se pisa.', "en": "The Data Steward's home: each dataset's sheet (owner, steward, custodian, criticality, freshness and quality SLAs, sensitivity), its certification, the quality incident queue, the schema contract and the audit trail of every change in business criteria. Everything is versioned: nothing is overwritten.", "pt": 'O lugar do Data Steward: a ficha de cada dataset (dono, steward, custodiante, criticidade, SLA de atualização e de qualidade, sensibilidade), sua certificação, a fila de incidentes de qualidade, o contrato de esquema e a auditoria de cada mudança de critério. Tudo fica versionado: nada é sobrescrito.'},
    "stw_kpi_datasets": {"es": 'Datasets', "en": 'Datasets', "pt": 'Datasets'},
    "stw_kpi_owner": {"es": 'Con dueño', "en": 'With owner', "pt": 'Com dono'},
    "stw_kpi_cert": {"es": 'Certificados', "en": 'Certified', "pt": 'Certificados'},
    "stw_kpi_open": {"es": 'Incidentes abiertos', "en": 'Open incidents', "pt": 'Incidentes abertos'},
    "stw_kpi_overdue": {"es": 'Fuera de SLA', "en": 'Past SLA', "pt": 'Fora do SLA'},
    "stw_kpi_mttr": {"es": 'Tiempo medio de resolución', "en": 'Mean time to resolve', "pt": 'Tempo médio de resolução'},
    "stw_by_domain": {"es": 'Abiertos por dominio', "en": 'Open by domain', "pt": 'Abertos por domínio'},
    "stw_whoami": {"es": 'Ver como steward', "en": 'View as steward', "pt": 'Ver como steward'},
    "stw_all": {"es": '(todos los stewards)', "en": '(all stewards)', "pt": '(todos os stewards)'},
    "stw_sub_board": {"es": 'Tablero', "en": 'Dashboard', "pt": 'Painel'},
    "stw_sub_sheet": {"es": 'Ficha y certificación', "en": 'Sheet & certification', "pt": 'Ficha e certificação'},
    "stw_sub_incidents": {"es": 'Incidentes', "en": 'Incidents', "pt": 'Incidentes'},
    "stw_sub_contract": {"es": 'Contrato de esquema', "en": 'Schema contract', "pt": 'Contrato de esquema'},
    "stw_sub_audit": {"es": 'Cambios de criterio', "en": 'Criteria changes', "pt": 'Mudanças de critério'},
    "stw_mine": {"es": 'Mis datasets', "en": 'My datasets', "pt": 'Meus datasets'},
    "stw_pending_cert": {"es": 'Pendientes de certificación', "en": 'Pending certification', "pt": 'Pendentes de certificação'},
    "stw_open_inc": {"es": 'Incidentes abiertos', "en": 'Open incidents', "pt": 'Incidentes abertos'},
    "stw_no_owner": {"es": 'Datasets sin dueño o sin steward', "en": 'Datasets without owner or steward', "pt": 'Datasets sem dono ou sem steward'},
    "stw_due": {"es": 'Vencimientos de SLA', "en": 'SLA breaches', "pt": 'Vencimentos de SLA'},
    "stw_none": {"es": 'Nada pendiente acá.', "en": 'Nothing pending here.', "pt": 'Nada pendente aqui.'},
    "stw_actions_hint": {"es": 'Acciones: asigná dueño y SLA en «Ficha y certificación», mové los incidentes en «Incidentes» y fijá el esquema en «Contrato de esquema».', "en": 'Actions: assign owner and SLAs in “Sheet & certification”, move incidents in “Incidents” and pin the schema in “Schema contract”.', "pt": 'Ações: atribua dono e SLA em “Ficha e certificação”, mova os incidentes em “Incidentes” e fixe o esquema em “Contrato de esquema”.'},
    "stw_pick_ds": {"es": 'Dataset', "en": 'Dataset', "pt": 'Dataset'},
    "stw_sheet_state": {"es": 'Versión {version} · certificación: {estado} · por {por} · el {en}', "en": 'Version {version} · certification: {estado} · by {por} · on {en}', "pt": 'Versão {version} · certificação: {estado} · por {por} · em {en}'},
    "stw_owner": {"es": 'Dueño de negocio', "en": 'Business owner', "pt": 'Dono de negócio'},
    "stw_steward": {"es": 'Data steward', "en": 'Data steward', "pt": 'Data steward'},
    "stw_custodian": {"es": 'Custodio técnico', "en": 'Technical custodian', "pt": 'Custodiante técnico'},
    "stw_domain": {"es": 'Dominio', "en": 'Domain', "pt": 'Domínio'},
    "stw_criticality": {"es": 'Criticidad', "en": 'Criticality', "pt": 'Criticidade'},
    "stw_crit_alta": {"es": 'Alta', "en": 'High', "pt": 'Alta'},
    "stw_crit_media": {"es": 'Media', "en": 'Medium', "pt": 'Média'},
    "stw_crit_baja": {"es": 'Baja', "en": 'Low', "pt": 'Baixa'},
    "stw_sla_fresh": {"es": 'SLA de frescura (horas, 0 = sin definir)', "en": 'Freshness SLA (hours, 0 = undefined)', "pt": 'SLA de atualização (horas, 0 = indefinido)'},
    "stw_sla_quality": {"es": 'SLA de calidad: umbral mínimo por dimensión (%)', "en": 'Quality SLA: minimum threshold per dimension (%)', "pt": 'SLA de qualidade: limiar mínimo por dimensão (%)'},
    "stw_pii": {"es": 'Contiene datos personales (PII)', "en": 'Contains personal data (PII)', "pt": 'Contém dados pessoais (PII)'},
    "stw_conf": {"es": 'Confidencial', "en": 'Confidential', "pt": 'Confidencial'},
    "stw_who": {"es": 'Quién hace el cambio', "en": 'Who makes the change', "pt": 'Quem faz a mudança'},
    "stw_reason": {"es": 'Motivo', "en": 'Reason', "pt": 'Motivo'},
    "stw_save_sheet": {"es": 'Guardar nueva versión de la ficha', "en": 'Save new sheet version', "pt": 'Salvar nova versão da ficha'},
    "stw_saved": {"es": 'Ficha guardada como versión nueva. La anterior queda en el historial.', "en": 'Sheet saved as a new version. The previous one stays in the history.', "pt": 'Ficha salva como nova versão. A anterior fica no histórico.'},
    "stw_error": {"es": 'No se pudo guardar:', "en": 'Could not save:', "pt": 'Não foi possível salvar:'},
    "stw_cert_title": {"es": 'Certificación', "en": 'Certification', "pt": 'Certificação'},
    "stw_cert_next": {"es": 'Pasar a', "en": 'Move to', "pt": 'Passar para'},
    "stw_cert_btn": {"es": 'Cambiar estado de certificación', "en": 'Change certification status', "pt": 'Mudar status de certificação'},
    "stw_cert_ok": {"es": 'Estado de certificación actualizado.', "en": 'Certification status updated.', "pt": 'Status de certificação atualizado.'},
    "stw_cert_terminal": {"es": 'Dataset deprecado: no admite más cambios de estado.', "en": 'Deprecated dataset: no further status changes.', "pt": 'Dataset depreciado: não admite mais mudanças de status.'},
    "stw_cert_borrador": {"es": 'Borrador', "en": 'Draft', "pt": 'Rascunho'},
    "stw_cert_en_revision": {"es": 'En revisión', "en": 'In review', "pt": 'Em revisão'},
    "stw_cert_certificado": {"es": 'Certificado', "en": 'Certified', "pt": 'Certificado'},
    "stw_cert_deprecado": {"es": 'Deprecado', "en": 'Deprecated', "pt": 'Depreciado'},
    "stw_history": {"es": 'Historial de la ficha (append-only)', "en": 'Sheet history (append-only)', "pt": 'Histórico da ficha (append-only)'},
    "stw_inc_note_sync": {"es": 'Cada regla que falla abre un incidente con el steward del dataset como responsable y un SLA de resolución según severidad. Si la regla vuelve a cumplir, se cierra sola.', "en": "Every failing rule opens an incident with the dataset's steward as owner and a resolution SLA by severity. If the rule passes again, it closes itself.", "pt": 'Cada regra que falha abre um incidente com o steward do dataset como responsável e um SLA de resolução por severidade. Se a regra voltar a cumprir, fecha sozinho.'},
    "stw_inc_abierto": {"es": 'Abierto', "en": 'Open', "pt": 'Aberto'},
    "stw_inc_en_curso": {"es": 'En curso', "en": 'In progress', "pt": 'Em andamento'},
    "stw_inc_resuelto": {"es": 'Resuelto', "en": 'Resolved', "pt": 'Resolvido'},
    "stw_inc_pick": {"es": 'Incidente', "en": 'Incident', "pt": 'Incidente'},
    "stw_inc_next": {"es": 'Nuevo estado', "en": 'New status', "pt": 'Novo status'},
    "stw_inc_comment": {"es": 'Nota', "en": 'Note', "pt": 'Nota'},
    "stw_inc_btn": {"es": 'Actualizar incidente', "en": 'Update incident', "pt": 'Atualizar incidente'},
    "stw_inc_ok": {"es": 'Incidente actualizado.', "en": 'Incident updated.', "pt": 'Incidente atualizado.'},
    "stw_inc_none": {"es": 'Sin incidentes de calidad.', "en": 'No quality incidents.', "pt": 'Sem incidentes de qualidade.'},
    "stw_con_intro": {"es": 'El contrato de esquema fija columnas, tipo, nulos, clave y valores aceptados. El inicial sale del perfilado real de la tabla; editalo y guardalo como versión vigente.', "en": "The schema contract pins columns, type, nulls, key and accepted values. The initial one comes from the table's real profile; edit it and save it as the current version.", "pt": 'O contrato de esquema fixa colunas, tipo, nulos, chave e valores aceitos. O inicial sai do perfilamento real da tabela; edite-o e salve como versão vigente.'},
    "stw_con_origin": {"es": 'Origen: {origen} · versión {version}', "en": 'Origin: {origen} · version {version}', "pt": 'Origem: {origen} · versão {version}'},
    "stw_con_viol": {"es": 'Violaciones del contrato hoy', "en": 'Contract violations today', "pt": 'Violações do contrato hoje'},
    "stw_con_ok": {"es": 'La tabla cumple su contrato.', "en": 'The table meets its contract.', "pt": 'A tabela cumpre seu contrato.'},
    "stw_con_save": {"es": 'Guardar como contrato vigente', "en": 'Save as current contract', "pt": 'Salvar como contrato vigente'},
    "stw_con_saved": {"es": 'Contrato guardado como versión nueva.', "en": 'Contract saved as a new version.', "pt": 'Contrato salvo como nova versão.'},
    "stw_con_yaml": {"es": 'Descargar contrato (YAML)', "en": 'Download contract (YAML)', "pt": 'Baixar contrato (YAML)'},
    "stw_audit_intro": {"es": 'Registro de cambios de criterio de negocio: reglas y umbrales de calidad, definiciones del glosario, contratos y certificaciones, con antes/después, quién, cuándo y motivo.', "en": 'Business criteria change log: quality rules and thresholds, glossary definitions, contracts and certifications, with before/after, who, when and why.', "pt": 'Registro de mudanças de critério de negócio: regras e limiares de qualidade, definições do glossário, contratos e certificações, com antes/depois, quem, quando e motivo.'},
    "stw_audit_none": {"es": 'Todavía no hay cambios registrados.', "en": 'No changes recorded yet.', "pt": 'Ainda não há mudanças registradas.'},
    "stw_local_note": {"es": 'Fichas, incidentes, contratos y cambios se guardan en la carpeta de datos del programa, en modo append-only (nunca se pisa el historial).', "en": "Sheets, incidents, contracts and changes are stored in the program's data folder, append-only (history is never overwritten).", "pt": 'Fichas, incidentes, contratos e mudanças ficam na pasta de dados do programa, em modo append-only (o histórico nunca é sobrescrito).'},
    "stw_err_sin_quien": {"es": 'falta el nombre de quien hace el cambio.', "en": 'the name of who makes the change is missing.', "pt": 'falta o nome de quem faz a mudança.'},
    "stw_err_tipo_cambio": {"es": 'tipo de cambio no reconocido.', "en": 'unrecognized change type.', "pt": 'tipo de mudança não reconhecido.'},
    "stw_err_criticidad": {"es": 'la criticidad tiene que ser alta, media o baja.', "en": 'criticality must be high, medium or low.', "pt": 'a criticidade deve ser alta, média ou baixa.'},
    "stw_err_frescura": {"es": 'el SLA de frescura son horas: un número mayor o igual a 0.', "en": 'the freshness SLA is in hours: a number greater than or equal to 0.', "pt": 'o SLA de atualização é em horas: um número maior ou igual a 0.'},
    "stw_err_sla_calidad": {"es": 'cada umbral de calidad va entre 0 y 100, en una de las 6 dimensiones.', "en": 'each quality threshold goes between 0 and 100, in one of the 6 dimensions.', "pt": 'cada limiar de qualidade vai entre 0 e 100, em uma das 6 dimensões.'},
    "stw_err_no_editable": {"es": 'ese campo no se edita desde la ficha (la certificación tiene su propio flujo).', "en": 'that field is not edited from the sheet (certification has its own flow).', "pt": 'esse campo não se edita pela ficha (a certificação tem seu próprio fluxo).'},
    "stw_err_transicion": {"es": 'ese cambio de estado no está permitido desde el estado actual.', "en": 'that status change is not allowed from the current status.', "pt": 'essa mudança de status não é permitida a partir do status atual.'},
    "stw_err_cert_sin_dueno": {"es": 'para certificar hacen falta dueño de negocio y data steward asignados.', "en": 'certifying requires an assigned business owner and data steward.', "pt": 'para certificar é preciso ter dono de negócio e data steward atribuídos.'},
    "stw_err_incidente": {"es": 'ese incidente no existe.', "en": 'that incident does not exist.', "pt": 'esse incidente não existe.'},
    "stw_err_contrato": {"es": 'el contrato necesita dataset, columnas sin nombres repetidos y tipos válidos.', "en": 'the contract needs a dataset, columns without repeated names and valid types.', "pt": 'o contrato precisa de dataset, colunas sem nomes repetidos e tipos válidos.'},
}
