...
name: ecc
description: >
  Layer ECC (github.com/affaan-m/ECC v2.2.0) instalado en MV Data Governance: reglas de estilo, testing,
...
1. Correr el gate real del repo y **pegar la salida cruda**, no un resumen:
   ...
   node --test  # tests de pago/licencia + XSS
   ```
   CI corre la matriz de versiones de Python, el gate de cero warnings de deprecación y el auto-diagnóstico del motor. Los cuatro cuentan.
